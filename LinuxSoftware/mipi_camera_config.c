...
alt_u8 OV8865_read_cmos_sensor_8(alt_u16 Addr){
	...
	//OC_I2CL_Write(h2p_lw_mipi_camera, device_address, SWAP16(Addr), (alt_u8 *)&Value, sizeof(Value));
	OC_I2CL_Read(h2p_lw_mipi_camera, device_address, Addr, (alt_u8 *)&Value, sizeof(Value));
...
void OV8865_read_AF(void){
	...
	bool bSuccess;
		...
		bSuccess = OC_I2C_Read_Continue(h2p_lw_mipi_camera, device_address, szData8, sizeof(szData8));
		if (bSuccess)
