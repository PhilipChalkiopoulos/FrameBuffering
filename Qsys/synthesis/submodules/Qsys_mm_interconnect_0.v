...
module Qsys_mm_interconnect_0 (
	...
	wire  [228:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                        // hps_0_f2h_axi_slave_agent:write_rp_data -> router_001:sink_data
	...
	wire  [228:0] router_001_src_data;                                                            // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [228:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                         // hps_0_f2h_axi_slave_agent:read_rp_data -> router_002:sink_data
	...
	wire  [228:0] router_002_src_data;                                                            // router_002:src_data -> rsp_demux_001:sink_data
	...
	wire  [228:0] cmd_demux_src0_data;                                                            // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [228:0] crosser_out_data;                                                               // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [228:0] cmd_demux_src1_data;                                                            // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [228:0] crosser_001_out_data;                                                           // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [228:0] rsp_demux_src0_data;                                                            // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [228:0] crosser_002_out_data;                                                           // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [228:0] rsp_demux_001_src0_data;                                                        // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [228:0] crosser_003_out_data;                                                           // crosser_003:out_data -> rsp_mux:sink1_data
