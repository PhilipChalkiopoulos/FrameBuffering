...
# setting SOPC_SYSID_BASE_ADDRESS is 0x410d0
SOPC_SYSID_FLAG += --sidp=0x410d0
ELF_PATCH_FLAG  += --sidp 0x410d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1463451056
SOPC_SYSID_FLAG += --timestamp=1463451056
ELF_PATCH_FLAG  += --timestamp 1463451056
